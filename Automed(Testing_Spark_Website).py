...
try:
    # Use find_element with By.CLASS_NAME to find an element by class name
...
print("TestCase #5:")
try:
    # Use find_element with By.ID to find an element by its ID
    element = driver.find_element(By.ID, "toTopHover")
    element.click()
    time.sleep(1)
    print("Scrolled up")
except NoSuchElementException:
    print("Element with ID 'toTopHover' not found.")

########################## TestCase 6:About Us Page #########################
print("TestCase #6:")

try:
    # Use find_element with By.LINK_TEXT to find an element by link text
    driver.find_element(By.LINK_TEXT, 'About Us').click()
    time.sleep(3)
    print('About Us link works!')
except NoSuchElementException:
...
try:
    # Use find_element with By.XPATH to find an element using XPath
...
try:
    ...
    driver.find_element(By.NAME, 'Name').send_keys('Utkarsh')
    time.sleep(3)
    print("Typing your Email address...")
    driver.find_element(By.NAME, 'Email').send_keys('Utkarsh989s@gmail.com')
    time.sleep(3)
...
try:
    ...
    print("Element not found or unable to navigate back")
print("")
